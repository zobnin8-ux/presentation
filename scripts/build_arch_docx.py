...
def build() -> None:
    ...
    para(doc, "Рекомендуем планировать: ~$300/мес (Vercel ~$150).", bold=True, size=10)
    ...
    para(doc, "Ориентир: ~$2 500–3 000 на подписки за полный цикл.", bold=True, size=10)
    ...
    table(
        ...
        [
            ["Гонорар (КП)", "$43 000"],
            ["Ваши подписки (~8 мес)", "~$2 500–3 000"],
    ...
    para(
        doc,
        "Вы каждый месяц: Cursor $60 + OpenAI ≥$50 + Anthropic ≥$50 + Vercel $100–200 = $260–360. "
        "За проект на подписки: ~$2 500–3 000. GRC платит prod-инфраструктуру отдельно. "
